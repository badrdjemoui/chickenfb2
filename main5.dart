        ...
        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double totalCost = doc['totalWeight'] * doc['pricePerKg'];
              ...
              return ListTile(
                ...
                subtitle: Text(
                  ...
                  'الوزن الكلي: ${doc['totalWeight']} كجم\n'
                  'سعر الكيلوغرام: ${doc['pricePerKg']} دينار\n'
                  'الكلفة الإجمالية: ${totalCost.toStringAsFixed(2)} دينار',
                ),
                trailing: IconButton(
...
class FarmerManagementPage extends StatefulWidget {
  @override
  _FarmerManagementPageState createState() => _FarmerManagementPageState();
}
...
class _FarmerManagementPageState extends State<FarmerManagementPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('إدارة قائمة المربيين'),
      ),
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return ListTile(
            ...
            trailing: IconButton(
              icon: Icon(Icons.delete, color: Colors.red),
              onPressed: () => _deleteFarmer(_farmers[index]['id']),
            ),
          );
        },
      ),
